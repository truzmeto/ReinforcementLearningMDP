...
In contrast, Q-learning algorithm takes a lot longer time to converge to optimal policy because even at very
...
value kept constant $\epsilon=0.2$. As we can see in Fig.4 by increasing learning rate optimal policy improves
...
Heatmap for Q-learning(Fig.7) show that 1000 iterations was not
...
is almost constant with iterations. 
